 ...
 */
export class RepulsionResponse extends CollisionResponse {
    /**
    ...
    collisionResponse(data: CollisionData, dt: number) {
        ...
        let vdx2 = 0;
        let vdy2 = 0;
        if (e2 instanceof MutableEntity && e2.body !== null && (ny < 1 || b1.velocityX * e2.body.velocityX + b1.velocityY * e2.body.velocityY < 0)) {
            b2 = e2.body;
